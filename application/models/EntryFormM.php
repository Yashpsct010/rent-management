...
// die();
  ...
  public function get_entry_form($property_id,$flat_no,$month,$status){

    $query = "SELECT * FROM entry_form_details WHERE property_id =$property_id AND flat_no = $flat_no AND month = '$month' and status = $status";
    // print_r($query);
    // die();
    $result = $this->db->query($query);
    return $result->result_array();
  }
public function get_entry_form_for_property($property_id, $month){

    $query = "SELECT * FROM entry_form_details WHERE property_id =$property_id AND month = '$month'";
    // print_r($query);
    // die();
    $result = $this->db->query($query);
    return $result->result_array();
