		...
		<div class="card">
			<div class="card-body">
				<div class="col-md-12">
					...
					<br>
					<form id="filter-report" action="<?php echo base_url('Report/TR_Report_details') ?>" method=post id=date>
						

                                  <!--  Code For From - To Date Wise Filtering  -->
